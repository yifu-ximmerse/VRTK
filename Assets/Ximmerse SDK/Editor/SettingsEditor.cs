...
namespace Ximmerse {
	...
	public class SettingsEditor:EditorWindow {
		...
		#region Static
        [MenuItem("Window/Ximmerse Setup VRTK")]
        static void SetUpExampleScene()
        {
            var go = GameObject.Find("Missing Prefab");
            if (go != null)
                DestroyImmediate(go);
            ...
            VRTK_SDKManager.instance.boundariesSDK = VRTK_SDKManager.SupportedSDKs.XimmerseVR;
            VRTK_SDKManager.instance.headsetSDK = VRTK_SDKManager.SupportedSDKs.XimmerseVR;
            VRTK_SDKManager.instance.controllerSDK = VRTK_SDKManager.SupportedSDKs.XimmerseVR;
            VRTK_SDKManager.instance.systemSDK = VRTK_SDKManager.SupportedSDKs.XimmerseVR;

            VRTK_SDKManager.instance.actualBoundaries = GameObject.Find("VRCameraRig");
            VRTK_SDKManager.instance.actualHeadset = GameObject.Find("CenterEyeAnchor");
            VRTK_SDKManager.instance.actualLeftController = GameObject.Find("LeftHandAnchor");
            VRTK_SDKManager.instance.actualRightController = GameObject.Find("RightHandAnchor");
            VRTK_SDKManager.instance.modelAliasLeftController = GameObject.Find("cobra02-L").transform.parent.gameObject;
            VRTK_SDKManager.instance.modelAliasRightController = GameObject.Find("cobra02-R").transform.parent.gameObject;
        }
